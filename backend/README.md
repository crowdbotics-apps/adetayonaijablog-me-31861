...
## Project Structure
    ...
    ├── adetayonaijablog_me_31861  # Django project configurations
...
1. Clone this repo and `cd adetayonaijablog_me_31861`
...
2. Clone this repo and `cd adetayonaijablog_me_31861`
